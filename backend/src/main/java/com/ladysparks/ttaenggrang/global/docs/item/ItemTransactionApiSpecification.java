...
@Tag(name = "[학생] 상품 거래", description = "상품 거래 관련 API")
public interface ItemTransactionApiSpecification {

    @Operation(summary = "(학생) 상품 구매 [등록]", description = """
            💡학생이 상품을 구매합니다.
    ...
    @Operation(summary = "(학생) 상품 판매 내역 [전체 조회]", description = """
            💡학생의 상품 판매 내역을 조회합니다.
    ...
    @Operation(summary = "(학생) 상품 구매 내역 [전체 조회]", description = """
            💡학생의 상품 구매 내역을 조회합니다.
    ...
    @Operation(summary = "(학생) 상품 사용 [수정]", description = """
            💡학생이 상품을 사용합니다.
